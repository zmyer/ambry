...
import static com.github.ambry.clustermap.ClusterMapUtils.UNKNOWN_DATACENTER_ID;
...
public class BlobId extends StoreKey {
    ...
    public BlobId(short version, BlobIdType type, byte datacenterId, short accountId, short containerId,
        ...
        this(version, type, datacenterId, accountId, containerId, partitionId, isEncrypted,
    ...
    public static boolean isCrafted(String idStr) throws IOException {
        BlobIdPreamble blobIdPreamble =
                new BlobIdPreamble(
                        new DataInputStream(new ByteBufferInputStream(ByteBuffer.wrap(Base64.decodeBase64(idStr)))));
