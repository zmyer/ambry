        ...
        if (!type.equals(Type.Uninitialized)) {
            if (offset == null || sessionId == null) {
                throw new IllegalArgumentException(
                        "Offset [" + offset + "] or SessionId [" + sessionId + "] cannot be null");
    ...
    static StoreFindToken fromBytes(DataInputStream stream, StoreKeyFactory factory) throws IOException {
        ...
        case VERSION_0:
            ...
            if (indexStartOffset != UNINITIALIZED_OFFSET) {
                ...
                storeFindToken =
                        new StoreFindToken(Type.JournalBased, new Offset(logSegmentName, offset), null, sessionIdUUID,
                                null,
                                false, VERSION_0);
            } else {
        ...
        case VERSION_1:
            ...
            case IndexBased:
                ...
                storeFindToken =
                        new StoreFindToken(Type.IndexBased, indexSegmentStartOffset, factory.getStoreKey(stream),
                                sessionIdUUID,
        ...
        case VERSION_2:
            ...
            case IndexBased:
                ...
                storeFindToken = new StoreFindToken(storeKey, indexSegmentStartOffset, sessionIdUUID,
                        incarnationIdUUID);
                break;
            default:
                throw new IllegalStateException("Unknown store find token type: " + type);
    ...
    public byte[] toBytes() {
        ...
        case VERSION_2:
            ...
            if (type != Type.Uninitialized) {
                size +=
                        INCARNATION_ID_LENGTH_SIZE + incarnationIdBytes.length + SESSION_ID_LENGTH_SIZE +
