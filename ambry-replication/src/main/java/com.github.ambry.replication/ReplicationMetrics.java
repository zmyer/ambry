  ...
  public ReplicationMetrics(MetricRegistry registry, List<? extends ReplicaId> replicaIds) {
    ...
    public void populatePerColoMetrics(Set<String> datacenters) {
        for (String datacenter : datacenters) {
            Meter interColoReplicationBytesRatePerDC =
                    registry.meter(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-ReplicationBytesRate"));
            ...
            Meter sslInterColoReplicationBytesRatePerDC =
                    registry.meter(MetricRegistry
                            .name(ReplicaThread.class, "SslInter-" + datacenter + "-ReplicationBytesRate"));
            ...
            Counter interColoMetadataExchangeCountPerDC =
                    registry.counter(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-MetadataExchangeCount"));
            ...
            Counter interColoBlobsReplicatedCountPerDC =
                    registry.counter(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-ReplicationBlobsCount"));
            ...
            Counter plainTextInterColoMetadataExchangeCountPerDC = registry.counter(
                    MetricRegistry
                            .name(ReplicaThread.class, "PlainTextInter-" + datacenter + "-MetadataExchangeCount"));
            ...
            Timer interColoReplicationLatencyPerDC =
                    registry.timer(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-ReplicationLatency"));
            ...
            Timer sslInterColoReplicationLatencyPerDC =
                    registry.timer(
                            MetricRegistry.name(ReplicaThread.class, "SslInter-" + datacenter + "-ReplicationLatency"));
            ...
            Histogram interColoExchangeMetadataTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-ExchangeMetadataTime"));
            ...
            Histogram interColoFixMissingKeysTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-FixMissingKeysTime"));
            ...
            Histogram interColoReplicationMetadataRequestTimePerDC = registry.histogram(
                    MetricRegistry
                            .name(ReplicaThread.class, "Inter-" + datacenter + "-ReplicationMetadataRequestTime"));
            ...
            Histogram plainTextInterColoReplicationMetadataRequestTimePerDC = registry.histogram(
                    MetricRegistry.name(ReplicaThread.class,
                            "PlainTextInter-" + datacenter + "-ReplicationMetadataRequestTime"));
            ...
            Histogram sslInterColoReplicationMetadataRequestTimePerDC = registry.histogram(
                    MetricRegistry
                            .name(ReplicaThread.class, "SslInter-" + datacenter + "-ReplicationMetadataRequestTime"));
            ...
            Histogram interColoCheckMissingKeysTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-CheckMissingKeysTime"));
            ...
            Histogram interColoGetRequestTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-GetRequestTime"));
            ...
            Histogram sslInterColoGetRequestTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "SslInter-" + datacenter + "-GetRequestTime"));
            ...
            Histogram interColoTotalReplicationTimePerDC =
                    registry.histogram(
                            MetricRegistry.name(ReplicaThread.class, "Inter-" + datacenter + "-TotalReplicationTime"));
    ...
    void trackLiveThreadsCount(final Map<String, List<ReplicaThread>> replicaThreadPools, String localDatacenter) {
        for (final String datacenter : replicaThreadPools.keySet()) {
            ...
            if (localDatacenter.equals(datacenter)) {
                ...
                registry.register(
                        MetricRegistry.name(ReplicaThread.class, "NumberOfInter-" + datacenter + "-ReplicaThreads"),
                        liveThreadsPerDatacenter);
            }
        }
    }
    ...
    public void addRemoteReplicaToLagMetrics(final RemoteReplicaInfo remoteReplicaInfo) {
        ...
        final String metricName =
                dataNodeId.getHostname() + "-" + dataNodeId.getPort() + "-" + replicaId.getPartitionId() +
                        "-replicaLagInBytes";
    ...
    public void createRemoteReplicaErrorMetrics(RemoteReplicaInfo remoteReplicaInfo) {
        String metadataRequestErrorMetricName =
                remoteReplicaInfo.getReplicaId().getDataNodeId().getHostname() + "-" + remoteReplicaInfo.getReplicaId()
                        .getDataNodeId()
                        .getPort() + "-" + remoteReplicaInfo.getReplicaId().getPartitionId().toString() +
